...
- Tutorial: Use Risk Detections for User Sign-ins to trigger Azure AD Multi-Factor Authentication or Password Changes ([ Learn.Microsoft.com Link ](https://learn.microsoft.com/en-us/azure/active-directory/authentication/tutorial-risk-based-sspr-mfa))<br>
